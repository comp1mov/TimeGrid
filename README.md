...
Текущая версия приложения: `TimeGrid v28.29`.
...
- `docs/TUTORIAL_01_GETTING_STARTED.md` — план первого обзорного видеоурока на 10-20 минут.
- `docs/CHRONOPHOTO.md` — фактическая модель Chronophoto и режимы Seam Blend.
